...
//  DailyQuoteApp
//
//  Created by Sarmad Ishfaq on 02/09/2021.
//

import UIKit

class ReflectionViewController: UIViewController {
    let quoteLabel =  label(text: CustomuserDefaults.reflectionText, textcolor: .white, font: .setFont(FontName: .Poppins_ExtraLight, fontSize: 18), alignment: .justified)
